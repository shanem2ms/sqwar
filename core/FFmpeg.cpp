...
namespace sam
{
    ...
    static int sTimeDenominator = 1000000;
    ...
    static int sframe = 0;
    void FFmpegOutputStreamer::WriteFrameYUV420(uint8_t* ydata, uint8_t* udata, uint8_t* vdata, double timestamp)
    {
        int err;
        if (!videoFrame) {
        ...
        //videoFrame->pts = sframe++; (int64_t)(timestamp * sTimeDenominator);
